 ...
 *******************************************************************************/
package com.heroku.eclipse.ui.git;
 ...
 */
public class HerokuCredentialsProvider extends CredentialsProvider {
	 ...
	 * Default constructor
	 */
	public HerokuCredentialsProvider() {
		// empty
	}
	 ...
	 * @param password
	 */
	public HerokuCredentialsProvider(String user, String password) {
		this.user = user;
